...
We are improving the ways that we reward all contributors in the Rabityield community. We try to be as fair as possible and use the treasury in an effective manner.
...
4. If you are a dev with some cred with Rabityield, you can propose a regular reward for continued contributions. 

## Steps

### 1. Fill out a proposal
Go to [vote.rabityield.finance](https://vote.rabityield.finance) and click on the big square that says "Rabityield.Finance". Once you're in, click on the [New Proposal](https://vote.rabityield.finance/#/rabityield/create) button.
...
It's important for Rabityield because...<BODY_OF_PROPOSAL>
...
The #development channel is a good place to get the attention of other rabityield devs. If you can post in #citadel, that's a great place to get the atention influential members of Rabityield as well.
