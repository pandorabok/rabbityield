    ...
    partners: [
      {
        ...
        text: "Rabityield Finance is The Multi-Chain Yield Optimizer across many blockchains, enabling users to earn autocompounded yield on their crypto. Did you know also that you can own a piece of Rabityield itself? Rabityield runs on its governance token, BIFI. The token has a set supply of 80,000 across all chains; no more may be minted, ever! As a holder of BIFI you may create and vote on important DAO proposals, and you become dividend-eligible to earn a share of every compounding harvest on Rabityield vaults, hour by hour. Here on Polygon, you just need to stake BIFI in this reward pool, or in the autocompounding BIFI Maxi vault on the main page. For this pool, MATIC dividends are gathered and sent proportionally to each staker. Stake here, return later to claim the MATIC you've earned.",
    ...
    partners: [
      {
        logo: 'stake/rabityield/rabityieldfinance.png',
        background: 'stake/rabityield/background.png',
        text: 'beQI is Rabityield Staked QI. The token is pegged to QI and can be staked on the Rabityield platform to earn QI or more beQI. beQI gives stakers access to max lock rewards of staking QI for eQI. You can burn beQI for QI if there is available QI reserves.',
        website: 'https://rabityield.com',
        social: {
          telegram: 'http://t.me/rabityieldfinance',
          twitter: 'https://twitter.com/rabityieldfinance',
        },
