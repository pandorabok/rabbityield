    ...
    partners: [
      {
        ...
        text: "Rabityield Finance is The Multi-Chain Yield Optimizer across many blockchains, enabling users to earn autocompounded yield on their crypto. Did you know also that you can own a piece of Rabityield itself? Rabityield runs on its governance token, BIFI. The token has a set supply of 80,000 across all chains; no more may be minted, ever! As a holder of BIFI you may create and vote on important DAO proposals, and you become dividend-eligible to earn a share of every compounding harvest on Rabityield vaults, hour by hour. Here on Fantom, you just need to stake BIFI in this reward pool, or in the autocompounding BIFI Maxi vault on the main page. For this pool, FTM dividends are gathered and sent proportionally to each staker. Stake here, return later to claim the FTM you've earned.",
    ...
    partners: [
      {
        logo: 'stake/rabityield/rabityieldfinance.png',
        background: 'stake/rabityield/background.png',
        text: 'beFTM simply means Rabityield Escrowed Fantom. The token is pegged to FTM and can be staked on the Rabityield platform and farms on major DEXs. beFTM gives stakers access to maximized validator rewards that typically aren’t available to the individual investor without locking FTM for 1 year.',
        website: 'https://app.rabityield.finance',
        social: {
          telegram: 'http://t.me/rabityieldfinance',
          twitter: 'https://twitter.com/rabityieldfinance',
    ...
    partners: [
      {
        ...
        text:
          ...
          'Lock your SPIRIT on Rabityield to mint binSPIRIT, Rabityield’s liquid version of inSPIRIT. Staking it directly on Rabityield gives you compounded interest on your SPIRIT and also allows you to exchange it at any time. \n' +
          'Deposit your mooBinSPIRIT (receipt for binSPIRIT deposited in our vaults) into the boost to earn mooBIFI.',
        website: 'https://app.rabityield.finance/',
        social: {
          telegram: 'https://discord.gg/rabityieldfinance',
          twitter: 'https://twitter.com/rabityieldfinance',
        },
      },
    ],
