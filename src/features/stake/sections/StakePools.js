        ...
        <Grid className={classes.faq} item xs={12} lg={9}>
          <Accordion square expanded={expanded === 'faq-1'} onChange={handleChange('faq-1')}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>How do I use Rabityield Launchpool?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                <img
                ...
                to the related partner Launchpool vault here on the Rabityield Launchpool site and enter
          ...
          <Accordion square expanded={expanded === 'faq-7'} onChange={handleChange('faq-7')}>
            ...
            <AccordionDetails>
              <Typography>
                A mooToken can be seen as a receipt that you get when depositing into any Rabityield vault.
                This is a fully automatic process. For example, you receive ‘mooBIFI’ tokens from
                depositing $BIFI into the Rabityield Maxi vault. These mooTokens do not 1:1 represent the
                ...
                Rabityield.Finance users should hold on tightly to the mooTokens i.e. deposit receipts
          ...
          <Accordion square expanded={expanded === 'faq-9'} onChange={handleChange('faq-9')}>
            ...
            <AccordionDetails>
              <Typography>
                mooBIFI is the token you receive from depositing $BIFI into the Rabityield Maxi vault.
                These mooTokens do not 1:1 represent the token amount initially deposited but it
                does represent the value of your share in the vault. The Rabityield Maxi vault gathers a
                performance fee from every Rabityield Vault when they are harvested, and uses it to buy
                more $BIFI and redeposit in the vault. The more profit the Rabityield generates, the more
          ...
          <Accordion square expanded={expanded === 'faq-10'} onChange={handleChange('faq-10')}>
            ...
            <AccordionDetails>
              <Typography>
                Yes! These partner vaults are hosted by Rabityield and are completely safe. Rabityield has
                gotten tokens from our partners and uses our own vaults for the reward. Those
                mooTokens your stake doesn’t leave Rabityield.
              </Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion square expanded={expanded === 'faq-12'} onChange={handleChange('faq-12')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                Rate” and is a fixed rate. Rabityield shows APR by dividing the annual yield into 365
                days and presents that to you as “Daily”. APY on the other hand means “Annual
                percentage yield” which is when you take the daily yield and compound it. Rabityield
          ...
          <Accordion square expanded={expanded === 'faq-14'} onChange={handleChange('faq-14')}>
            ...
            <AccordionDetails>
              <Typography>
                When partnering with a certain project, Rabityield always tries to make an overall check
                ...
                Rabityield cannot, and will not take any responsibility for your personal actions.
              </Typography>
            </AccordionDetails>
          </Accordion>
          {appNetworkId === 56 ? (
