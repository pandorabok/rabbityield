...
export const getNetworkTokens = () => {
  ...
  switch (chainId) {
    ...
    default:
      throw new Error(
        `Create address book for chainId(${chainId}) first. Check out https://github.com/rabityieldfinance/address-book`
      );
  }
};
      ...
      return {
        ...
        providerOptions: {
          ...
          'custom-cb-bsc': {
            ...
            options: {
              appName: 'Rabityield Finance',
              appLogoUrl: 'https://app.rabityield.finance/static/media/BIFI.e797b2e4.png',
              darkMode: false,
            },
            package: WalletLink,
            connector: async (ProviderPackage, options) => {
