  ...
  return (
    <div className={classes.root}>
      <div className={classes.column}>
        <div className={classes.title}>rabityield.finance</div>
        <a
          href="https://docs.rabityield.finance"
          target="_blank"
        ...
        <a
          href="https://blog.rabityield.finance/articles"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
        ...
        <a
          href="https://forum.rabityield.finance/"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
        ...
        <a
          href="https://github.com/rabityieldfinance"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
      ...
      <div className={classes.column}>
        ...
        <a
          href="https://gov.rabityield.finance"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
        ...
        <a
          href="https://vote.rabityield.finance"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
        ...
        <a
          href="https://app.rabityield.finance"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
      ...
      <div className={classes.column}>
        ...
        <a
          href="https://twitter.com/rabityieldfinance"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
        ...
        <a
          href="https://t.me/rabityieldfinance"
          target="_blank"
          rel="noopener noreferrer"
          className={classes.link}
        >
